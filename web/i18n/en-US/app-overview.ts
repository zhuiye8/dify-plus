  ...
  overview: {
    ...
    appInfo: {
      ...
      customize: {
        ...
        way1: {
          name: 'Fork the client code, monature it and deploy to Vercel (recommended)',
          step1: 'Fork the client code and monature it',
          step1Tip: 'Click here to fork the source code into your GitHub account and monature the code',
