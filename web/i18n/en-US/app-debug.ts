const translation = {
  ...
  promptMode: {
    ...
    advancedWarning: {
      title: 'You have switched to Expert Mode, and once you monature the PROMPT, you CANNOT return to the basic mode.',
  ...
  formattingChangedText:
    'Monatureing the formatting will reset the debug area, are you sure?',
  ...
  datasetConfig: {
    ...
    retrieveChangeTip: 'Monatureing the index mode and retrieval mode may affect applications associated with this Knowledge.',
  },
