const translation = {
  ...
  intro1: 'دانش می‌تواند در برنامه Nature ',
  ...
  externalAPIPanelDescription: 'API دانش خارجی برای اتصال به یک پایگاه دانش خارج از Nature و بازیابی دانش از آن پایگاه دانش استفاده می شود.',
