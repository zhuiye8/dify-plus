const translation = {
  ...
  welcome: 'Dobrodošli v Nature, prosimo, prijavite se za nadaljevanje.',
  ...
  license: {
    tip: 'Preden začnete z Nature Community Edition, preberite GitHub',
    link: 'Licenco odprte kode',
  },
  join: 'Pridruži se',
  joinTipStart: 'Vabimo vas, da se pridružite',
  joinTipEnd: 'ekipi na Nature',
  invalid: 'Povezava je potekla',
  explore: 'Razišči Nature',
  ...
  licenseExpiredTip: 'Licenca za Nature Enterprise za vaš delovni prostor je potekla. Če želite še naprej uporabljati Nature, se obrnite na skrbnika.',
  usePassword: 'Uporaba gesla',
  sendVerificationCode: 'Pošlji kodo za preverjanje',
  resetPasswordDesc: 'Vnesite e-poštni naslov, ki ste ga uporabili za prijavo na Nature, in poslali vam bomo e-poštno sporočilo za ponastavitev gesla.',
  ...
  licenseLostTip: 'Povezava z licenčnim strežnikom Nature ni uspela. Če želite še naprej uporabljati Nature, se obrnite na skrbnika.',
  licenseInactiveTip: 'Licenca Nature Enterprise za vaš delovni prostor je neaktivna. Če želite še naprej uporabljati Nature, se obrnite na skrbnika.',
}
