const translation = {
  ...
  intro1: 'Wiedzę można zintegrować z aplikacją Nature ',
  ...
  externalAPIPanelDescription: 'Interfejs API wiedzy zewnętrznej służy do łączenia się z bazą wiedzy poza Nature i pobierania wiedzy z tej bazy wiedzy.',
  chunkingMode: {
