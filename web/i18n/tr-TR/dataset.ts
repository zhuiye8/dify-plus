const translation = {
  ...
  intro1: 'Bilgi, Nature uygulamasına ',
  ...
  externalAPIPanelDescription: 'Harici bilgi API\'si, Nature dışındaki bir bilgi bankasına bağlanmak ve bu bilgi bankasından bilgi almak için kullanılır.',
