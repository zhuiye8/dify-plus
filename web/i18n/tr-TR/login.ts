const translation = {
  ...
  welcome: 'Nature\'ye hoş geldiniz, devam etmek için lütfen giriş yapın.',
  ...
  license: {
    tip: 'Nature Community Edition\'ı başlatmadan önce GitHub\'daki',
  ...
  resetPasswordDesc: 'Nature\'a kaydolmak için kullandığınız e-postayı yazın, size bir şifre sıfırlama e-postası gönderelim.',
  ...
  back: 'Geri',
  licenseExpiredTip: 'Çalışma alanınız için Nature Enterprise lisansının süresi doldu. Nature\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseLostTip: 'Nature lisans sunucusuna bağlanılamadı. Nature\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseInactiveTip: 'Çalışma alanınız için Nature Enterprise lisansı etkin değil. Nature\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
