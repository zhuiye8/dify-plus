const translation = {
  ...
  welcome: 'Benvenuto su Nature, per favore accedi per continuare.',
  ...
  license: {
    tip: 'Prima di avviare Nature Community Edition, leggi su GitHub',
    link: 'Licenza open-source',
  },
  join: 'Unisciti',
  joinTipStart: 'Invitato a unirti al',
  joinTipEnd: 'team su Nature',
  invalid: 'Il link è scaduto',
  explore: 'Esplora Nature',
  ...
  resetPasswordDesc: 'Digita l\'e-mail che hai utilizzato per registrarti su Nature e ti invieremo un\'e-mail per reimpostare la password.',
  ...
  licenseLostTip: 'Impossibile connettersi al server licenze Nature. Contatta il tuo amministratore per continuare a utilizzare Nature.',
  licenseExpired: 'Licenza scaduta',
  licenseLost: 'Licenza persa',
  licenseExpiredTip: 'La licenza Nature Enterprise per la tua area di lavoro è scaduta. Contatta il tuo amministratore per continuare a utilizzare Nature.',
  licenseInactiveTip: 'La licenza Nature Enterprise per la tua area di lavoro è inattiva. Contatta il tuo amministratore per continuare a utilizzare Nature.',
